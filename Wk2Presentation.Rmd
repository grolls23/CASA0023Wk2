...
.center[EM Thermal Bands of VIIRS (NOAA, 2013)]
...
.pull-left[
**Fire Monitoring**: 
  * Using VIIRS 375m products for fire detection (Olivia & Schroeder, 2015)
...
.center[Cumulative Fire Intensity for 2020 (NASA)]
]

.pull-right[

**Light Emissions**: 
  * Light Emissions data as a proxy for economic activity? (Mellander et al., 2015)
  * Day-Night Band (0.5 - 0.5µm) designed to capture lights from Earth's surface at night
  * Is often used to measure urban development (Florida, 2008) but can it be applied to estimate the extent of economic activity?
...
* Better tool for estimating population than any daytime datasets (Mellander et al)
]
